...
const Busqueda = () => {
    ...
    const { buscador, handleBuscador, arrProyectos } = useProyectos();

    const proyectosFiltrados = busqueda === '' ? [] : arrProyectos.filter(proyecto => proyecto.name.toLowerCase().includes(busqueda.toLowerCase()))
