...
const EditarProyecto = () => {
  ...
  const { getProject, proyecto, cargando, deleteProject } = useProyectos();
  ...
  const handleClick = () => {
    if (confirm('Seguro que desea eleminar el proyecto?'))
  ...
  return (
    <>
      <div className='flex justify-between'>
        <h1 className='font-black text-4xl'>Editar proyecto <span className='text-sky-600'>{name}</span></h1>
